<?php
  ...
  Class CurrencyManager{
    ...
    // Construtor incluído para gerar a chave de acesso à API externa da configuração docker secrets 
    function __construct(){

      $secret = fopen("/run/secrets/api-key", "r");

      while ($line = fgets($secret)) {
        $word .= $line;
      }
      fclose($secret);

      $this->apiKey = trim($word);
