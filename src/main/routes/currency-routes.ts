...
import { makeConvertCurrencyController } from '../factories/controllers/convert-currency/convert-currency-controller-factory'
...
export default (router: Router): void => {
  ...
  router.get('/currency/convert?', adaptRoute(makeConvertCurrencyController()))
