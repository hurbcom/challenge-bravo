...
describe('ConvertionUtil', () => {
    ...
    describe('baseCurrencyConvertion', () => {
        ...
        it('Should call getRequest when cache does not have avaiable data.', async () => {
            ...
            expect(getFromCacheStub).to.be.calledOnceWith('https://economia.awesomeapi.com.br/json/all/USD-BRL')
            expect(getRequestStub).to.be.calledWith('https://economia.awesomeapi.com.br/json/all/USD-BRL')
            expect(putToCacheStub).to.calledWith('https://economia.awesomeapi.com.br/json/all/USD-BRL', {
                'USD': {
                    high: 2
                }
            })
