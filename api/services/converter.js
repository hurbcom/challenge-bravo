class Converter {
     ...
     */
    static convertCurrencyToUSD(currency_key,currency_value,currencies){
     ...
     * @returns {float}
     */
    static convertUSDToCurrency(currency_key,dolar_value,currencies){
     ...
     * @returns {float} 
     */
    static convertfromToCurrency(from,to,value,currencies){
