...
func NewGetExternalQuote(quoteRepository repository.QuoteRepository, awesomeApiClient awesomeapi.AwesomeApiClient, environment env.Environment) GetExternalQuote {
	return &getExternalQuoteImpl{quoteRepository: quoteRepository, awesomeApiClient: awesomeApiClient, environment: environment}
}
...
func (s getExternalQuoteImpl) getQuoteToBankCurrency(dto *GetExternalQuoteDto, bankCurrencyCode string) (*domain.Quote, error) {
	...
	s.quoteRepository.SaveQuote(&repository.QuoteEntity{
