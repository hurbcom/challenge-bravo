...
internal static class CurrencySeed
{
    internal static void GenerateInitialCurrencies(this MigrationBuilder migrationBuilder)
        ...
        $@"
            INSERT INTO {nameof(Currency)}({nameof(Currency.Symbol)}, {nameof(Currency.Name)}, {nameof(Currency.ValueInDollar)}, {nameof(Currency.Available)}, {nameof(Currency.LastUpdateAt)}) VALUES ('USD', 'Dollar',   1, TRUE, '1000-01-01');
