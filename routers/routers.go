...
func Generate() *mux.Router {
	...
	router.HandleFunc("/currency", controllers.PutCurrency).Methods(http.MethodPut)
	router.HandleFunc("/currency", controllers.DeleteCurrency).Methods(http.MethodDelete)
