...
- Formato para requisições via API local 
    - http://<localhost>/api/currencyConversion/getCurrenciesQuotation/{currencySymbol}
    - http://<localhost>/api/convert/from/{fromCurrency}/to/{toCurrency}/amount/{amount:decimal}/
